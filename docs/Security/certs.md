...
!!! example "Add CA certificate to trust store"

    --8<-- "includes/tasks/add-certificate.md"

## Commands

#### openssl

--8<-- "includes/cmd/openssl/info.md"
...
The update-ca-certificates utility updates the trust store based on its configuration file at **/etc/ca-certificates.conf**
